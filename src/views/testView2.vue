    ...
    return {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          editable: params => !(params.data.bezeichnung === "ZWISCHENSUMME" || params.data.bezeichnung === "ENDSUMME" || params.data.bezeichnung === "STARTSUMME"),
          cellRenderer: params => params.value === null || params.value === 0 || params.value === "" ? null : params.value + "%"
        },
        {
          headerName: 'Aufwand',
          field: 'aufwand',
    ...
    berechne() {
      ...
      for (let i = this.rowData.length - 2; i >= 1; i--) {
        if (this.rowData[i].bezeichnung === "ZWISCHENSUMME") {
          ...
          this.rowData[i].anteilZwischensumme = Math.round((this.rowData[i].aufwand / zwischenSummeAufwand+Number.EPSILON) * 100)
