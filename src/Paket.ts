...
export class Paket {
    ...
    constructor(ticket_nr: string | null, thema: string | null, beschreibung: string | null, komponente: string | null, bucket: Bucket | null, schaetzung: number | null, open: boolean | null, lvl: number, parent: Paket | null, children: Paket[], id?: number) {
