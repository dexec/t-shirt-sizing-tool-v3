<template>
  <div v-if="params.data instanceof Zwischensumme">
    ...
    <div v-else><p class="text-caption pt-2">{{ params.data.vorigerAbschnittAufschlag }}%</p>
      <p></p></div>
  </div>
...
export default {
  name: "AufschlagCellRenderer",
  computed: {
    Zwischensumme() {
      return Zwischensumme;
    },
    aufschlagWert() {
      return this.params.data.berechneAufschlag();
    },
    vorigerAbschnittAufschlag() {
      return this.params.data.vorigerAbschnittAufschlag;
    }
  },
  setup(props) {
    return {
